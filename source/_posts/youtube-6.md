...
幫我產生Short #3: The Wild Bird That Collects Spider Silk  video prompt + 背景音 Prompt(含鳥叫聲,不含音樂)
"
# next 2
"
...
### Model 
#### [Model Lucy](https://chatgpt.com/c/69ca13e4-aa24-83a8-97fe-3afdbed56795)
``` bash
fix prompt:
same character Lucy, consistent facial identity, East Asian woman, age around 25, soft oval face, almond-shaped dark brown eyes, straight natural eyebrows, small defined nose, soft natural lips, clear fair skin, long straight dark black hair, center-parted hair, elegant and calm presence

negative prompt:
no extra fingers, no bad hands, no deformed anatomy, no asymmetrical eyes, no blurry face, no cartoon style, no anime style, no exaggerated makeup, no smiling teeth, no fantasy costume, no jewelry overload, no watermark, no text

# 當你之後要讓 Lucy 出現在不同畫面，可以這樣寫：
Lucy, the same consistent East Asian female character, identical face, same long straight dark black hair, same elegant facial features, same calm and graceful presence...

# 再接場景，例如：
- walking in a rainy neon street
- sitting by a window in morning sunlight
- standing in a cinematic ancient courtyard
- talking softly in a luxury hotel lobby

# 一個最簡化、最好複製的版本
Lucy, a beautiful East Asian woman, age around 25, elegant and timeless beauty, soft oval face, refined delicate features, almond-shaped dark brown eyes, straight natural eyebrows, small defined nose, soft natural lips, clear fair skin, long straight dark black hair, center-parted hair, calm gentle expression, graceful feminine presence, realistic proportions

wearing an elegant ivory silk dress, minimal luxury style, cinematic portrait photography, ultra-realistic, soft studio lighting, clean plain background, upper body shot, front-facing, eye-level camera, centered composition, highly consistent identity, character reference image, realistic skin texture, realistic hair strands

no extra fingers, no deformed anatomy, no asymmetrical eyes, no cartoon style, no anime style, no fantasy elements, no text, no watermark
...
# 做法 1
固定使用同一張主基準圖當 reference image
# 做法 2
每套服裝 prompt 都保留這幾個詞：
the same East Asian female character, identical face as the reference images, same facial structure, same hairstyle, same eyes, same skin tone, highly consistent identity
# 做法 3
一次不要改太多
先只改：
服裝
...
鏡頭距離
# 給影片用的服裝 prompt 寫法
如果你接下來是要做 video prompt，可把服裝段縮成這種格式：
Lucy, the same East Asian female character, identical face as the reference images, same facial structure, same hairstyle, same eyes, same skin tone, wearing a premium beige trench coat over a cream dress, elegant urban style, calm graceful presence
