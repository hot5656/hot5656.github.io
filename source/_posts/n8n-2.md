...
##### 11_119 AI Agent output string,convert to json
``` js
...
#### google Gemini  API key - [ Google AI Studio](https://aistudio.google.com/) - [Usage](https://ai.dev/usage?tab=rate-limit), [Condition](https://ai.google.dev/gemini-api/docs/rate-limits)
``` bash
login 
--> get API key 
--> Create API key
